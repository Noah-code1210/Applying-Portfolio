      ...
      <div ref={ref} className="about--grid">
        ...
        <motion.div initial="hidden" animate={controls} variants={opacityVariant} transition={{ duration: 1, delay: 2 }} onAnimationComplete={() => handleComplete()} className="about--detail">
          <p className="theme--detail--dark">
            <ScrambleText delay={2}>I'm currently seeking a frontend software engineer position, with a strong preference for remote opportunities. However, I'm also open to on-site roles if the right fit comes along. I'm passionate about creating intuitive, responsive user interfaces and contributing to impactful web experiences! </ScrambleText>
          </p>
        </motion.div>
