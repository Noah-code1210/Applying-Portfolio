  ...
  return (
    <header ref={ref}>
      ...
      <motion.div initial="hidden" animate={controls} variants={blurVariants} transition={{ duration: 1, delay: 0.5 }} className="header--top">
        <h3>
          <a href="https://github.com/Noah-code1210" target={"_blank"} rel="noopener noreferrer">
            <ScrambleText shuffle delay={0.5}>
              GITHUB
            </ScrambleText>
          </a>
          <span className="header--hash">{"//"}</span>
          <a href="https://www.linkedin.com/in/noah-cole-87241b320/" target={"_blank"} rel="noopener noreferrer">
      ...
      <motion.div initial="hidden" animate={controls} variants={blurVariants} transition={{ duration: 1, delay: 4 }} className="header--bottom">
        <div>
          ...
          <p className="theme--detail">
            <ScrambleText shuffle delay={4}>
              HI!!! I’m Noah, I tackle complex engineering challenges daily, alongside a team of elite software engineers. My mission is to continuously advance in web development, using my growing expertise to drive societal progress through technology.
            </ScrambleText>
          </p>
        </div>
      ...
      <h1 className="header--name">
        <TextWriting controls={controls} text={"Noah Cole"} noblink />
        <br />
